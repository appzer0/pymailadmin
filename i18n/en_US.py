...
translations = {
    ...
    'source_label': 'Alias Name (the "Source")',
    'destination_label': 'Mailbox (the "Destination")',
    'btn_modify': 'Modify',
    'btn_cancel': 'Cancel',
    ...
    'old_password_field_label': 'Current Mailbox Password:',
    'password_field_label': 'New Mailbox Password:',
    'btn_modify_mailbox': 'Modify mailbox',
    'mailbox_edit_failed': 'Failed to modify mailbox.',
    'password_too_short': 'The password is too short.',
    'old_password_incorrect': 'The current password is incorrect.',
    'lost_mailbox_password': 'If you\'ve lost your mailbox password, there is NOTHING we can do about it: your password is the personal, unique key used to encrypt all your mail data. Therefore, any accees is impossible if you lose the key (and we don\'t have it either!). You\'ll have to destroy and re-create the mailbox. Sad but true, sorry.',
    ...
    'password_changed_title': 'Mailbox password changed',
    'password_changed': 'Mailbox password has been changed. Your mailbox is being re-encrypted with new password.',
    ...
    'btn_create': 'My password has been saved somewhere safe. Create Mailbox',
    'mailbox_created': 'The new following mailbox has just been created successfully.',
    ...
    'mailbox_creation_mailbox_hint': 'Minimum 6 chars (64 max) of lowercase letters (a-z), digits (0-9), dash (-), underscore (_). No ',
    'mailbox_creation_domain_hint': 'Choose a domain for you new mailbox',
    'mailbox_creation_password_hint': 'Minimum 12 chars (64 max). Make it complex enough. NOTE IT DOWN AND BACK IT UP SOMEWHERE SAFE! USE A PASSWORD MANAGER OR MAKE SURE YOU WILL REMEMBER IT! IF YOU LOSE YOUR MAILBOX PASSWORD, YOU\'LL LOSE ALL MAIL DATA! WE WON\'T BE ABLE TO RECOVER IT! YOU\'VE BEEN WARNED!',
